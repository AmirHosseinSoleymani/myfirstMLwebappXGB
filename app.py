...
model = joblib.load('xgbpipebySoley.joblib')
st.title('Will you survive if you were among Titanic passengers or not :ship:')
# PassengerId,Pclass,Name,Sex,Age,SibSp,Parch,Ticket,Fare,Cabin,Embarked
passengerid = st.text_input("Input Passenger ID", '1011') 
pclass = st.selectbox("Choose class", [1,2,3])
name  = st.text_input("Input Passenger Name", 'AmirHosseinSoleymani')
...
ticket = st.text_input("Input Ticket Number", "1111") 
